...
class ResNet_Deit(nn.Module):   # S-Former after stage3
...
def spatial_transformer_Deit():
    return ResNet_Deit(BasicBlock, [2, 2, 2, 2])

def spatial_transformer(depth=1):
    return ResNet(BasicBlock, [2, 2, 2, 2], depth=depth)


def spatial_transformer_resnet34(depth=1):
    return ResNet(BasicBlock, [3, 4, 6, 3], depth=depth)
